...
type Props = {
    ...
    errors: any;
    onFileChange: any;
    fileList: {name:string}[] | null
}

export const CreateForm = ({register,onSubmit,control,categories,errors,onFileChange,fileList}: Props) => {
    return(
        <form onSubmit={onSubmit}>
           <div className="mb-3">
            ...
            <Button className="mt-3 min-w-[150px]">Send</Button>
        </form>
    )
}